...
class Mapmanager():
    ...
    def __init__(self, loader, render):
        ...
        self.colors = [
            (0.2, 0.2, 0.35, 1), # biru laut
            (0.2, 0.5, 0.2, 1), # hijau rumput
            (0.7, 0.2, 0.2, 1), # merah tanah
            (0.5, 0.3, 0.0, 1) # coklat gunung
        ] #rgba
    ...
    def startNew(self):
        ...
        self.land = self.render.attachNewNode("Land") #the node which all the map blocks are attached to
    ...
    def saveMap(self):
        ...
        with open('my_map.dat', 'wb') as fout:
            ...
            for block in blocks:
                x, y, z = block.getPos()
                pickle.dump((int(x), int(y), int(z)), fout)
